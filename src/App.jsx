...
import Course from "../component_courses/Course";
import Playlist from "../component_courses/Playlist";
import Quiz from "../component_courses/Quiz";
    ...
    <>
      <BG>
        ...
        <Routes>
          ...
          <Route path="/courses/playlist" element={<Playlist />} />
