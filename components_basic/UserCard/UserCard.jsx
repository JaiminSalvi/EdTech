...
export default function UserCard() {
  ...
  //   if (user.following) {
  //     set_following(user.following.length);
  //     set_followe_list(user.following);
  //   }
    ...
    <div className="flex flex-row">
      ...
      >
        <Card w="25vw" h="60vh" mt="[2vh]" ml="3vw">
          ...
          >
            <div
              className="flex flex-col items-center mb-2 justiy-center bg-[rgb(0,0,0,0)] rounded-lg"
            ...
            >
              {/* <div
                className="px-2 bg-[#222222] rounded-lg text-center mb-2"
                style={{
                  fontSize: "4vh",
                  color: "white",
                }}
              ...
              <div
                className="px-2 bg-[#222222] rounded-lg text-center mb-2 flex items-center"
                style={{
                  fontSize: "1.5vh",
                  color: "white",
              ...
              <Card w="18vw" h="20vh" mt="[0vh]" ml="2vw">
                <div className="flex justify-center items-center ">
                  <div
                    className="flex flex-col justify-cennter items-center flex-wrap p-2 m-2"
                    style={{
        ...
        <Card w="25vw" h="27vh" mt="[2vh]" ml="3vw">
          ...
          >
            ...
            <div className={styles.codeBlock}>
              ...
              <span className={styles.className} style={{ color: "white" }}>
                {tag}
              </span>{" "}
              <span style={{ color: "#05BD05" }}>{"{"}</span> <br />
              &nbsp;&nbsp;&nbsp;
              <span className={styles.variable}>
                String <span className={styles.variableName}>name = </span>
              </span>
              <span className={styles.value}>{`"${name}"`}</span><span style={{color:"white"}}>;</span>
              <br />
              &nbsp;&nbsp;&nbsp;<span className={styles.variable}>String </span>
              <span className={styles.variableName}>year = </span>{" "}
              <span className={styles.value}>{`"${year}"`}</span>
              <span style={{color:"white"}}>;</span>
              <br />
              &nbsp;&nbsp;&nbsp;
              <span className={`${styles.dataType}`}>
                object<span className={styles.variableName}> id = </span>
              </span>{" "}
              <span
      ...
      <div id="outer2" style={{ width: "73vw" }}>
        <div className="flex justify-center ">
          <Card w="31vw" h="38vh" mt="[2vh]" mr="1vw">
            <div className="flex gap-4 justify-content-center align-items-center ">
              <h1 className="ml-[4vw]" style={{ fontSize: "5vh" }}>
                {" "}
                Rank : {rank}
              </h1>
              <div
                className="px-2  rounded-lg text-center mb-2"
                style={{
                  fontSize: "5vh",
                  // color: "white",
                }}
            ...
            <div className="flex ">
              <div
                className="flex flex-col ml-[4vw]"
                style={{
                  //width : '20vw',
                  gap: "0.01vw",
                }}
              >
                <p>
                  ...
                  <br></br>
                  avergae raiting : {raiting}
                  <br></br>
                  posts : {post} <br></br>
                  {user && !you && !follower_list.includes(id) && (
                    <button
                      className="btn bg-[aqua] h-[1.5em] w-[10em] flex justify-center items-center"
        ...
        <div className="flex justify-center items-center">
          <Card w="64vw" h="20vh" mt="[2vh]" p="4">
            <div className="flex ">
              <Timeline
                range={dateRange}
                data={data}
                colorFunc={({ alpha }) => `rgba(0 , 225 , 225 , ${alpha})`}
              />
            </div>
          </Card>
        </div>
        ...
        <div className="flex justify-center items-center">
          <Card w="64vw" h="27vh" mt="[2vh]">
            <div className="flex justify-between">
              <span>
                <p style={{ display: "inline" }}> previous queries</p>
              </span>
              <span>
                <a
                  className="btn bg-[aqua] h-[1.5em] w-[10em] flex justify-center items-center "
